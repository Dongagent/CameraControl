...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\SATO\\OneDrive\\Coding\\Dr.Sato\\exp_202311\\4-2_ResumeGaze-Board_lastrun.py',
...
exer_trials = data.TrialHandler(nReps=2.0, method='random', 
    ...
    trialList=data.importConditions('xlsx/ResumeGazewithBoard.xlsx'),
