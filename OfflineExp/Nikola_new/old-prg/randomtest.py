...
expName = 'randomtest'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\smart\\OneDrive\\Coding\\Dr.Sato\\202310_PsychoPy\\randomtest.py',
...
# --- Initialize components for Routine "start_position" ---
...
for thisTrial in trials:
    ...
    for thisTrial_2 in trials_2:
        ...
        if trialCounter % nRestTrial == 0:
            ...
            isRest = 0
        # keep track of which components have finished
        routine_1Components = [text_countdown]
    ...
    # --- Prepare to start Routine "start_position" ---
    continueRoutine = True
    routineForceEnded = False
    # update component parameters for each repeat
    text_2.setText(modality
)
    text_3.setText(modality_lr)
    text_4.setText(movepoint)
    text_5.setText(movepoint_lr)
    ...
    sum_ = num_01 + num_02 + num_03 + num_04
    text_6.setText(sum_)
    # keep track of which components have finished
    start_positionComponents = [text_2, text_3, text_4, text_5, mouse_2, text_6]
    for thisComponent in start_positionComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # the Routine "start_position" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
