...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\SATO\\OneDrive\\Coding\\Dr.Sato\\202310_PsychoPy\\ResumeMultiTwo_2_lastrun.py',
...
text_6 = visual.TextStim(win=win, name='text_6',
    text='デモ\nランダムな表情、会話内容、プロソディを計24パターンを確認ください。',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
for thisTrial_4 in trials_4:
    ...
    trials_3 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Random_Two.xlsx'),
    ...
    for thisTrial_3 in trials_3:
        ...
        # Run 'Begin Routine' code from stim_end_demo_2
        time.sleep(1)
...
# set up handler to look after randomisation of conditions etc
trials_5 = data.TrialHandler(nReps=0.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 0.0 repeats of 'trials_5'
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('ResumeMultiTwo.xlsx'),
