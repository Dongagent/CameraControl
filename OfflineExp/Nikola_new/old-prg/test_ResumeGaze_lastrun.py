...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\SATO\\OneDrive\\Coding\\Dr.Sato\\exp_202311\\old\\test_ResumeGaze_lastrun.py',
...
num_01 = 1 #modality
num_02 = 1 #modality_lr
num_03 = 1 #movepoint
num_04 = 1 #movepoint_lr
...
led.status = None
# keep track of which components have finished
CheckComponents = [check_l_msg, led]
...
if led.keys in ['', [], None]:  # No response was made
    led.keys = None
thisExp.addData('led.keys',led.keys)
if led.keys != None:  # we had a response
    thisExp.addData('led.rt', led.rt)
thisExp.nextEntry()
...
for thisTrial in trials:
    ...
    test_trials = data.TrialHandler(nReps=12.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('C:/Users/SATO/OneDrive/Coding/Dr.Sato/exp_202311/xlsx/ResumeGaze.xlsx'),
