...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\SATO\\OneDrive\\Coding\\Dr.Sato\\202310_PsychoPy\\ResumeMulti_2_lastrun.py',
...
# --- Initialize components for Routine "Demo_fin" ---
...
for thisTrial_4 in trials_4:
    ...
    trials_3 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('exercise.xlsx'),
    ...
    for thisTrial_3 in trials_3:
        ...
        routineForceEnded = False
        # update component parameters for each repeat
        # Run 'Begin Routine' code from stim_ex_2
        num_01 = text
        num_02 = prosody
        num_03 = expression
    ...
    # --- Prepare to start Routine "Demo_fin" ---
    continueRoutine = True
    routineForceEnded = False
    # update component parameters for each repeat
    ...
    # keep track of which components have finished
    Demo_finComponents = []
    for thisComponent in Demo_finComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Ending Routine "Demo_fin" ---
    for thisComponent in Demo_finComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # the Routine "Demo_fin" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('ResumeMulti.xlsx'),
