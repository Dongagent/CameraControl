...
import json
import time
# Run 'Before Experiment' code from Init_pose
import socket
import threading
import time
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\SATO\\OneDrive\\Coding\\Dr.Sato\\202310_PsychoPy\\ResumeGaze_v2_lastrun.py',
...
# Run 'Begin Experiment' code from stop_idlebe
# Connection to ROS bridge server
...
# Run 'Begin Experiment' code from Init_pose
# 変数設定
...
# Run 'Begin Experiment' code from ikimasu
json_data_ikimasu = {
...
# Run 'Begin Experiment' code from start_idlebe
completely_off_false = {
...
for thisTrial in trials:
    ...
    # Define JSON data
    json_string = json.dumps(completely_off_true)
    ...
    init_cmd1 = "HeadController={\"id\":\"HeadController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.0,\"y\":0.7,\"z\":1.5},\"translateSpeed\":2.0}\n"
    
    client1.send(init_cmd1.encode("utf-8"))
    time.sleep(1)
    
    init_cmd2 = "facs InnerBrow 0 Outerbrow 0 UpperLid -1 LowerLid 1 Cheek 0 NoseWrinkler 0 UpperLip 0 LipCorner 0 MouthCornerStickout 0 MouthOpen 0 JawDrop 0\n"
    
    client2.send(init_cmd2.encode("utf-8"))
    time.sleep(1)
    # Run 'Begin Routine' code from ikimasu
    json_string = json.dumps(json_data_ikimasu)
    topic = roslibpy.Topic(client, '/tts', 'std_msgs/String')
    message = roslibpy.Message({'data': json_string})
    topic.publish(message)
    time.sleep(2)
    
    start_cmd1 = "HeadController={\"id\":\"HeadController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":1.0}\n"
    start_cmd2 = "facs InnerBrow 0 Outerbrow 0 UpperLid 0 LowerLid 0 Cheek 0 NoseWrinkler 0 UpperLip 0 LipCorner 0 MouthCornerStickout 0 MouthOpen 0 JawDrop 0\n"
    client1.send(start_cmd1.encode("utf-8"))
    client2.send(start_cmd2.encode("utf-8"))
    ...
    headcmd = ["HeadController={\"id\":\"HeadController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":2}\n", \
                ...
                "HeadController={\"id\":\"HeadController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":-1.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":2}\n"]
    eyecmd = ["EyeController={\"id\":\"EyeController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":2.1}\n", \
                "EyeController={\"id\":\"EyeController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":1.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":2.1}\n", \
                "EyeController={\"id\":\"EyeController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":-1.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":2.1}\n"]
    ...
    def nikola_head():
        if num_03 == 1:
            ...
            cmd1 = headcmd[0]
        client1.send(cmd1.encode("utf-8"))
    ...
    def nikola_eye():
        if num_03 == 1:
            ...
            cmd = eyecmd[0]
        client1.send(cmd2.encode("utf-8"))
    ...
    back_cmd1 = "HeadController={\"id\":\"HeadController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":2.0}\n"
    back_cmd2 = "EyeController={\"id\":\"EyeController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.0,\"y\":1.2,\"z\":1.5},\"translateSpeed\":2.0}\n"
    back_cmd3 = "facs InnerBrow 0 Outerbrow 0 UpperLid 0 LowerLid 0 Cheek 0 NoseWrinkler 0 UpperLip 0 LipCorner 0 MouthCornerStickout 0 MouthOpen 0 JawDrop 0\n"
    client1.send(back_cmd1.encode("utf-8"))
    client1.send(back_cmd2.encode("utf-8"))
    client2.send(back_cmd3.encode("utf-8"))
    
    time.sleep(1)
    # Run 'Begin Routine' code from Init_pose_2
    end_cmd1 = "HeadController={\"id\":\"HeadController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.0,\"y\":0.7,\"z\":1.5},\"translateSpeed\":2.0}\n"
    end_cmd2 = "facs InnerBrow 0 Outerbrow 0 UpperLid -1 LowerLid 1 Cheek 0 NoseWrinkler 0 UpperLip 0 LipCorner 0 MouthCornerStickout 0 MouthOpen 0 JawDrop 0\n"
    
    client1.send(end_cmd1.encode("utf-8"))
    client2.send(end_cmd2.encode("utf-8"))
    
    #client1.send(init_cmd1.encode("utf-8"))
    #client2.send(init_cmd2.encode("utf-8"))
    
    time.sleep(3)
    # Run 'Begin Routine' code from start_idlebe
    json_string = json.dumps(completely_off_false)
    
    topic = roslibpy.Topic(client, '/do_idle_behavior', 'std_msgs/String')
    message = roslibpy.Message({'data': json_string})
    topic.publish(message)
    
    end_cmd1 = "HeadController={\"id\":\"HeadController\",\"motionTowardObject\":\"\",\"targetMotionMode\":2,\"targetPoint\":{\"x\":0.7,\"y\":0.5,\"z\":1.5},\"translateSpeed\":2.0}\n"
    end_cmd2 = "facs InnerBrow 0 Outerbrow 0 UpperLid 0 LowerLid 0 Cheek 0 NoseWrinkler 0 UpperLip 0 LipCorner 0 MouthCornerStickout 0 MouthOpen 0 JawDrop 0\n"
...
client.terminate()
# Run 'End Experiment' code from Init_pose
client1.close()
client2.close()
